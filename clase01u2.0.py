...
print(f"Participante: {participante3.nombre}, Rut: {participante3.rut}, ID único: {participante2._idparticipante}, Edad: {participante2.edad}, Inscripción Nº: {participante2._numeroinscripcion}\n")
print(f"Participante: {participante3.nombre}, Rut: {participante4.rut}, ID único: {participante2._idparticipante}, Edad: {participante2.edad}, Inscripción Nº: {participante2._numeroinscripcion}\n")
print(f"Participante: {participante3.nombre}, Rut: {participante5.rut}, ID único: {participante2._idparticipante}, Edad: {participante2.edad}, Inscripción Nº: {participante2._numeroinscripcion}\n")
print(f"Participante: {participante3.nombre}, Rut: {participante6.rut}, ID único: {participante2._idparticipante}, Edad: {participante2.edad}, Inscripción Nº: {participante2._numeroinscripcion}\n")
